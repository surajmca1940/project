...
class DashboardWidgetAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        ('Widget Configuration', {
            'fields': ['title', 'widget_type', 'chart_type', 'position', 'is_active']
        }),
        ('Settings', {
            'fields': ['config', 'refresh_interval']
        }),
        ('Filters', {
            'fields': ['institution_filter', 'region_filter']
        }),
        ('Timestamps', {
...
class RegionalAnalyticsAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        ('Basic Information', {
            'fields': ['region', 'date', 'total_active_users']
        }),
        ('Usage Patterns', {
            'fields': ['language_usage', 'cultural_resource_access', 'peak_usage_hours']
        }),
        ('Mental Health Data', {
            'fields': ['crisis_interventions', 'common_concerns', 'resource_effectiveness']
        })
    ]
